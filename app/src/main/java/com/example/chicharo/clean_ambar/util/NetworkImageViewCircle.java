...
public class NetworkImageViewCircle extends ImageView {
     ...
     * {@link NetworkImageViewCircle#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link NetworkImageViewCircle#setDefaultImageResId(int)} and
     * {@link NetworkImageViewCircle#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
                ...
                new ImageListener() {
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                            setImageBitmap(roundBit(response.getBitmap()));
